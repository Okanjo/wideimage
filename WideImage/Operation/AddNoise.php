...
class WideImage_Operation_AddNoise {
	...
	/**
	 * Adds color noise by altering given R,G,B values using specified amount
	 *
	 * @param $r
	 * @param $g
	 * @param $b
	...
	/**
	 * Adds mono noise by altering given R,G,B values using specified amount
	 *
	 * @param $r
	 * @param $g
	 * @param $b
	...
	/**
	 * Adds salt&pepper noise by altering given R,G,B values using specified amount
	 *
	 * @param $r
	 * @param $g
	 * @param $b
